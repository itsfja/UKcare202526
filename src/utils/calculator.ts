...
export function getDefaultInput(): FinancialAssessmentInput {
  return {
    ...
    isStHelensMode: false,
    customerName: 'Margaret Davies',
    customerRef: 'STH-4491-X',
    nino: 'QQ 12 34 56 C',
    assessorName: 'Visiting Officer Gribble',
    ...
    stHelens: {
      ...
      firstName: 'Margaret',
      lastName: 'Davies',
      address: '42 Peasley Cross Lane, St Helens, WA9 1RQ',
      dob: '1948-04-12',
      phone: '01744 555123',
      mobile: '07700 900077',
      maritalStatus: 'widowed',
      peopleLivingWith: [
        { name: 'None', dob: '', relationship: '' }
      ],
      partnerBenefits: {},
      carersAllowancePaid: false,
      carersAllowancePaidTo: '',
      housingBenefitPaid: true,
      housingBenefitAmount: 100,
      councilTaxBenefitPaid: true,
      councilTaxBenefitAmount: 20,
      pensions: [
        { payee: 'Margaret Davies', netAmount: 45.00, frequency: 'weekly', provider: 'Pilkington Pensions', evidence: true }
      ],
      passHalfOccupationalPension: false,
      earnings: [],
      capitalAccounts: [
        { holder: 'Margaret Davies', bank: 'Halifax Savings', accountNo: '4820-9182', amount: 12000, evidence: true }
      ],
      giftedCapital: false,
      giftedDetails: '',
      willMade: 'yes',
      executors: [
        { name: 'John Davies (Son)', address: '12 Rainford Road, St Helens, WA10 6BX' }
      ],
      willLocation: 'Frodshams Solicitors, St Helens',
      propertyType: 'semi-detached',
      propertyTypeOther: '',
      paysCouncilTax: true,
      annualCouncilTax: 1250,
      soleOwner: 'yes',
      jointOwner: 'no',
      otherOwnersShare: '',
      mortgageSecured: 'no',
      mortgageDetails: { provider: '', balance: 0, monthlyRepayment: 0 },
      deedsLocation: 'Held at home',
      partnerOrRelativeOwns: 'no',
      relativeRelationship: '',
      rentedPrivateLandlord: 'no',
      rentedHousingAssociation: 'no',
      rentAmount: 0,
      rentFrequency: 'weekly',
      serviceChargesIncluded: 'no',
      ...
      otherPropertyOccupied: 'no',
      otherPropertyRentalIncome: 'no',
      otherPropertyRentAmount: 0,
      otherPropertyRentFrequency: 'weekly',
      otherPropertyMortgage: 'no',
      ...
      repType: 'voluntary',
      repName: 'John Davies',
      repAddress: '12 Rainford Road, St Helens, WA10 6BX',
      repPhone: '07700 900088',
      repRelationship: 'Son',
    },
  };
}
