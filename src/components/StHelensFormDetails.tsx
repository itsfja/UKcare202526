...
export const StHelensFormDetails: React.FC<StHelensFormDetailsProps> = ({ input, onChange }) => {
  ...
  // Safely grab or initialize stHelens
  const stHelens = input.stHelens || {
    services: 'community',
    title: '',
    firstName: '',
    lastName: '',
    ...
    deedsLocation: '',
    partnerOrRelativeOwns: 'na',
    relativeRelationship: '',
    rentedPrivateLandlord: 'na',
    rentedHousingAssociation: 'na',
    rentAmount: 0,
    ...
    otherPropertyOccupied: 'na',
    otherPropertyRentalIncome: 'na',
